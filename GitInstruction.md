...
Работа над совместным проектом требует осуществление контроля версии. Это позволяет без ущерба основной версии вносить изменеия,         сравнивать и по необходимости включать их в проект.
